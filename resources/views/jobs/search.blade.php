...
@section('content')
    ...
    <section class="section-hero overlay inner-page bg-image"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="text-white font-weight-bold">Resultado Busqueda</h1>
                    <div class="custom-breadcrumbs">
                        <a href="#">Inicio</a> <span class="mx-2 slash">/</span>
                        <a href="#">Trabajos</a> <span class="mx-2 slash">/</span>
                        <span class="text-white"><strong>{{ asset('assets/images/hero_1.jpg') }}</strong></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row mb-5 justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 class="section-title mb-2"> Resultado Busqueda </h2>
                </div>
            </div>
                ...
                @else
                    <div class="container">
                        <div class="alert alert-success">
                            <p class="text-center"> Ningun trabajo concuerda con su busqueda </p>
                        </div>
                    </div>
                @endif
            </ul>
